...
def create_openai_256_kaliyuga_model(use_checkpoint=False, **kwargs):
    return partial(UNetModel, **OPENAI_256_KALIYUGA_CONFIG)(use_checkpoint=use_checkpoint, **kwargs)
